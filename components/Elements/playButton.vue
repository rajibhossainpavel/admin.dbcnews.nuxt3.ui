<template>
  <svg
    ...
    class="absolute inset-0 z-50 w-10 h-10 m-auto opacity-70"
  >
    <g>
      <circle cx="256" cy="256" fill="#ff6b6b" r="256"></circle>
      <path
        d="m512 256h-512c0 141.385 114.615 256 256 256s256-114.615 256-256z"
        fill="#ff1f3d"
      ></path>
      <g>
        <g>
